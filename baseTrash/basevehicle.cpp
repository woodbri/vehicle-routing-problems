...
std::cout<<"BaseVehicle::findNearestNodeTo passed assert\n";
    bool flag= false;
    double bestDist=-1;
    double d;
...
else std::cout<<"BaseVehicle::findNearestNodeTo not compatible"<<twc->isCompatibleIAJ( path[size()-1]  , unassigned[i], dumpSite )<<"\n";
    }

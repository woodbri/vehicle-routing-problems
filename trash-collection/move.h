...
class Move {
  ...
  public:
    Move() { nid1 = nid2 = rid1 = rid2 = pos1 = pos2 = -1; savings = std::numeric_limits<double>::min(); };
    Move(int _nid1, int _nid2, int _rid1, int _rid2, int _pos1, int _pos2, double _sav) {
        nid1 = _nid1;
        nid2 = _nid2;
        rid1 = _rid1;
        rid2 = _rid2;

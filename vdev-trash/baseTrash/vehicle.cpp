...
/*
double Vehicle::testInsertLIFO(const Order &order, const Orders &orders, int &pickPos, int &delPos,const TWC<Trashnode> &twc) {
std::cout<<"***************LIFO********************\n";
       //lastDelivery 
       //lastPickup
       //check if its D's -> O
...
double Vehicle::testInsertFIFO(const Order &order, const Orders &orders, int &pickPos, int &delPos,const TWC<Trashnode> &twc) {
std::cout<<"***************FIFO********************\n";
       //lastDelivery 
       //lastPickup
       //check if its D's -> O
...
double Vehicle::testInsertPUSH(const Order &order, const Orders &orders, int &pickPos, int &delPos,const TWC<Trashnode> &twc) {
std::cout<<"***************PUSH********************\n";
       //lastDelivery 
       //lastPickup
       //check if its D's -> O
...
bool Vehicle::e_feasable4(const Trashnode& n1, const Trashnode& n2,const Dpnode& n3,const Dpnode& n4) {
       path.resize(1);
       path.insert(n1,1);
       path.insert(n2,2);
       path.insert(n3,3);
...
/*******
bool Vehicle::insertOrderAfterLastPickup(const Order &order,const TWC<Trashnode> &twc){
    int i;
